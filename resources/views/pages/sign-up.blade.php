        ...
        <div class="main-wrapper">
            <section class="authentication-section position-absolute d-flex">
                        ...
                        <div class="authentication-content-wrap">
                            ...
                            <div class="validation-input-form-wrap">
                                <div class="validation-input-form-block w-form">
                                    ...
                                    <form id="wf-form-Password" name="wf-form-Password" method="POST"
                                          action="{{ route('user.signup') }}" class="validation-input-form">
                                        @csrf
                                        <div class="validation-name-wrap">
                                            <div class="validation-name-block">
                                                <label for="Fast-Name" class="validation-input-field-level"> Name</label>
                                                <input class="varidation-form-text-field w-input" maxlength="256"
                                                       id="name" type="text" name="name" placeholder="First name"
                                                       value="{{ old('name') }}" required />
                                                       @error('name') <span class="text-danger" style="color: #e74c3c">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                        <label for="Email-Address" class="validation-input-field-level">Email Address</label>
                                        <input class="varidation-form-text-field w-input" maxlength="256" id="email" type="email"
                                        ...
                                        <label for="Password" class="validation-input-field-level">Password</label>
                                        <input class="varidation-form-text-field w-input" maxlength="256" id="password"
                                               type="password" name="password" placeholder="Password" required />
                                               @error('password') <span class="text-danger" style="color: #e74c3c">{{ $message }}</span> @enderror
                                        <label for="Password" class="validation-input-field-level">Confirm Password</label>
                                        <input class="varidation-form-text-field w-input" maxlength="256"
                                               id="password_confirmation" type="password" name="password_confirmation"
                                               placeholder="Confirm Password" required />
                                               
                                        <div class="login-condition-block">
                                            <div class="login-conditon-title">Already have an account?</div>
                                            <a href="{{ url('user/login') }}" class="register-link">Login</a>
                                        </div>
                                        <input type="submit" data-wait="Please wait..." class="button-primary text-center w-button"
                ...
                <div class="authentication-banner">
                    <img src="../cdn.prod.website-files.com/65c992c37023d69385565acc/65e6e12b4f03e2d8440da7a9_authentication%20-banner.jpg"
                         loading="lazy" alt="Authentication Banner" class="authentication-banner-image" />
                </div>
            </section>
                    ...
                    <div data-w-id="930cbbf2-e22c-508e-4443-ba9f31767a12" class="footer-content">
                        ...
                        <div class="footer-block">
                            ...
                            <div class="footer-link-wrapper"><a href="{{ url('home') }}"
                                    ...
                                    class="footer-link">About</a><a href="{{ url('appointment') }}"
                                    class="footer-link">Appointment</a><a href="{{ url('doctors') }}"
